...
const cli = () => {
  argv
    ...
    .example('$0 set SECRET_NAME value https://github.com/owner [--visibility all | private | selected]')
    .example('$0 setAll secrets.env https://github.com/owner [--visibility all | private | selected]')
